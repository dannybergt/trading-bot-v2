...
- Phase 2 mit fuenf Wellen abgeschlossen: Chart-Overlays (lightweight-charts v5 + VWAP), Earnings/Dividenden/Splits ueber FMP, Volume-Profile mit Point-of-Control, KI-Erklaerbarkeit (xgboost_pred_contribs + Kategorie-Roll-up + P(UP)/P(DOWN)), Net-Yield-Gate mit Schema-Erweiterung (Alembic-Migration `0003_add_user_tax_rates`/`a3c1d4f5e6b7`); 60 Unit-Tests OK; API-Regression gruen

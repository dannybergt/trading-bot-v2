...
- **Fundamentals detail** (FMP) — explicit identifier and fundamentals block grouped into four sub-sections: *Identifiers* (ISIN, WKN derived from German ISINs, CUSIP, exchange, currency), *Valuation* (market cap, P/E TTM, forward P/E, P/B TTM, P/S TTM, beta), *Earnings & balance sheet* (EPS TTM, latest annual revenue and net income with fiscal-year date, ROE TTM, debt-to-equity TTM), *Dividend* (yield TTM, sum of trailing-365-day dividends, payout ratio TTM). The WKN is mechanically derived from DE-ISINs (positions 6–11) and only appears for German listings; non-DE symbols simply omit it.

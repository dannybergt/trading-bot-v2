...
| TBV2-Z08 | Oberflaeche ist DE/EN parallel, Auswahl persistiert (`CLAUDE.md` UX-Direktive) | Bei Sprache=Deutsch sind die Ueberschriften uebersetzt und ueberleben einen Reload | L2 | ui-regression: `ui_i18n_german` und — seit 2026-08-11 hier gefuehrt — `ui_admin_i18n_german`, der dieselbe Zusage fuer die Admin-Seite haelt; Struktur: `test_i18n_bundles.py`, `test_admin_page_i18n.py` (liest die Quelle und verlangt fuer jeden sichtbaren Textknoten einen Weg durch `t()`, weil ein Browserschritt nur **einen** Datenzustand sieht) | Entfernter Key laesst zwei Tests rot werden und nennt den Pfad (belegt 2026-07-28) | Kern |
